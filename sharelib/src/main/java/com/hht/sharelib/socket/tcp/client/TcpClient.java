package com.hht.sharelib.socket.tcp.client;
...
import com.hht.sharelib.socket.TCPConstants;
import com.hht.sharelib.socket.tcp.DataHandle;
 ...
 */
public class TcpClient implements DataHandle.DataListener {
    ...
    public TcpClient startConnectServer(final String ip, final TcpClientListener listener){
